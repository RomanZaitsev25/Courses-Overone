...
# Вывести в алфавитном порядке никальные фамилии и инициалы тех сотрудников,
# которые были в командировке в Москве.
import sqlite3

conn = sqlite3.connect('name12.db')
...
('Баранов П.Е.','Воронеж', 450, '2020-07-19', '2020-06-25');
''')

cursor.execute('''
SELECT DISTINCT name FROM travel
WHERE city = 'Москва'
ORDER by name ASC;
